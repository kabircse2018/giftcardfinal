                ...
                <form>
                  ...
                  <div class="row">
                    ...
                    <div class="form-group col-md-3">
                      ...
                      <input type="text" class="form-control" name="customer_id" placeholder="Customer/Order ID">
                    </div>
                    ...
                    <div class="form-group col-md-3">
                      ...
                      <input type="text" class="form-control" name="ordere_qty" placeholder="Order Qty">
                    </div>
